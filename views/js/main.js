...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var numPizza = myPizzas.length;
    //all pizzas are same size so no need to calculate dx and newwidth each time
    var newwidth = myPizzas[0].offsetWidth + determineDx(myPizzas[0],size) + 'px';
    for (var i = 0; i < numPizza; i++) {
      myPizzas[i].style.width = newwidth;
    }
  }
...
//change querySelectorAll to getElementByClassName and move out of loop and into a var
